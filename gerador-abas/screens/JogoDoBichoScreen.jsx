...
export default function JogoDoBichoScreen() {
    ...
    const [animalGerado, setAnimalGerado] = useState('Clique em gerar');
  ...
  return (
    <View>
      <Card style={{ margin: 5}}>
        <Card.Content>
          <Text>Gerador de Animal</Text>
          <Text variant='displayMedium'>Nome: {animalGerado.nome}</Text>
          <Text variant='displayMedium'>Número: {animalGerado.numero}</Text>
